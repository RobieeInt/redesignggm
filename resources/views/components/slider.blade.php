          ...
          >
            ...
            <ul>
              ...
              >
                ...
                <div
                  class="tp-caption tp-resizeme right-image-layer"
                ...
                >
                  <img
                    src="images/demo-decor-store-slider-01-img-02.jpg"
                ...
                >
                  <img
                    src="images/demo-decor-store-slider-01-img-03.jpg"
                    alt="background-pattern"
                    data-ww="100%"
                    data-hh="auto"
                  />
                ...
                <div
                  class="tp-caption tp-resizeme product-image-layer"
                ...
                >
                  <img
                    src="https://placehold.co/1678x740"
                    alt="background-pattern"
                    data-ww="100%"
                    data-hh="auto"
                  />
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Price starting from
                        <span
                          class="text-decoration-line-bottom-medium fw-600 text-dark-gray"
                          >$199.00</span
                        >
                      </div>
                      <!-- end subtitle layer -->
                      ...
                      >
                        <i
                          class="feather icon-feather-shopping-bag pe-10px icon-small"
                        ></i
                        >Shop Now
                      </a>
                      <!-- end button layer -->
                ...
                <div
                  class="tp-caption alt-font d-flex align-items-center"
                  id="slide-1-layer-11"
                  ...
                  data-paddingleft="[0,0,0,0]"
                >
                  <span class="pe-20px">More information</span
                  ><a
                    href="#"
                    class="d-flex justify-content-center align-items-center icon-box w-45px h-45px rounded-circle border border-color-transparent-dark-very-light border-2"
                    ><i class="bi bi-info icon-extra-medium text-dark-gray"></i
                  ></a>
                </div>
                <!-- end sub text layer -->
                <!-- start tooltip layer -->
                <div
                  class="tp-caption tooltip-arrow"
                  id="slide-1-layer-12"
                  data-x="['right','right','center','center']"
                  data-hoffset="['0','12','0','0']"
                  data-y="['bottom','bottom','top','top']"
                  data-voffset="['83','110','55','45']"
                  data-width="310"
                  data-height="auto"
                  data-whitespace="normal"
                  data-fontsize="['14','14','36','30']"
                  ...
                  style="
                    z-index: 36;
                    background-color: rgba(22, 32, 44, 0.85);
                    color: rgba(255, 255, 255, 0.8);
                    border-radius: 6px;
                  "
                >
                  The three-seater works not just as the primary seating option,
                  but also as an elegant statement piece.
                </div>
                <!-- end tooltip layer -->
                ...
                <div class="navigation-arrow">
                  ...
                  <div
                    class="tp-caption rev-btn d-flex justify-content-center align-items-center text-derk-gray btn btn-large bg-white btn-slide-right pb-5px md-pb-0 text-uppercase"
                    id="slide-1-layer-13"
                    data-x="['left','left','center','center']"
                    data-hoffset="['0','0','-50','-80']"
                  ...
                  <div
                    class="tp-caption rev-btn alt-font d-flex justify-content-start align-items-center text-derk-gray text-uppercase pb-5px next-btn"
                    id="slide-1-layer-14"
                    data-x="['left','left','center','center']"
                    ...
                    style="
                      border: none;
                      background-image: url(https://placehold.co/200x115);
                    "
                  ></div>
              ...
              >
                ...
                >
                  <img
                    src="images/demo-decor-store-slider-02-img-05.jpg"
                    alt="background-pattern"
                    data-ww="100%"
                    data-hh="auto"
                  />
                ...
                >
                  <img
                    src="images/demo-decor-store-slider-02-img-06.jpg"
                    alt="background-pattern"
                    data-ww="100%"
                    data-hh="auto"
                  />
              ...
              >
                ...
                >
                  <img
                    src="images/demo-decor-store-slider-03-img-08.jpg"
                    alt="background-pattern"
                    data-ww="100%"
                    data-hh="auto"
                  />
                ...
                >
                  <img
                    src="images/demo-decor-store-slider-03-img-09.jpg"
                    alt="background-pattern"
                    data-ww="100%"
                    data-hh="auto"
                  />
